...
<div style="background:url(http://m-img.cafe24.com/images/webzine/center/box_bg_001.gif) repeat-y; padding:0 35px; font:12px/1.5em dotum; color:#444444;">\
        <p style="float:left; margin:0; height:35px;">\
                <img src="http://m-img.cafe24.com/images/webzine/center/logo_cafe24_03.gif" alt="cafe24 호스팅센터" /><br />\
        </p>\
...
\
\
        <img src="http://m-img.cafe24.com/images/webzine/1204/mail_120403_501.jpg" alt="환영합니다! 앱 세팅이 완료되었습니다." /><br />\
        <p style="margin:0; padding:10px 0 0 0;">\
                <span style="font:13px/1.3em verdana; color:#444;">안녕하세요, <strong style="color:#006cb8;">카페24 호스팅센터</strong>입니다.</span><br /><br />\
                카페24 호스팅 서비스의 중요 안내(만료 안내, 시스템 점검 안내 등)는 "관리자 메일주소"로 안내됩니다.<br />\
                고객님의 연락처 정보 및 이메일주소를 항상 최신 정보로 업데이트 해주시기 바랍니다<br />\
        </p>\
\
        <!-- -->\
...
하신 점은 카페24 고객센터(http://help.cafe24.com)으로 문의주시기 바랍니다..20220321 test 버전입니다555........^^</li>\
        </ul>\
\
\
\
